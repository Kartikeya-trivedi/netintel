...
const TYPE_STYLES: Record<EntityType, { label: string; className: string }> = {
  PERSON: {
    label: 'Person',
    className: 'text-ent-person border-ent-person/40',
  },
  ORG: { label: 'Org', className: 'text-ent-org border-ent-org/40' },
  LOCATION: {
    label: 'Location',
    className: 'text-ent-location border-ent-location/40',
  },
  PHONE: { label: 'Phone', className: 'text-ent-phone border-ent-phone/40' },
  BANK_ACCOUNT: {
    label: 'Account',
    className: 'text-ent-account border-ent-account/40',
  },
  VEHICLE: {
    label: 'Vehicle',
    className: 'text-ent-vehicle border-ent-vehicle/40',
  },
  WEAPON: {
    label: 'Weapon',
    className: 'text-ent-contraband border-ent-contraband/40',
  },
  DRUG: {
    label: 'Narcotic',
    className: 'text-ent-contraband border-ent-contraband/40',
...
export default function EntityBadge({ type }: { type: EntityType }) {
  ...
  return (
    <span
      className={`inline-flex shrink-0 rounded-md border px-2 py-0.5 text-xs font-semibold ${style.className}`}
    >
      {style.label}
    </span>
  )
